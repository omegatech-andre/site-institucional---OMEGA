                  ...
                  <tbody>
                    {lineItem.category.flatMap((categoryItem) =>
                      categoryItem.product.map((product) => {
                        ...
                        return (
                          <tr
                            className={`pageboletimtecnico__tablecontent ${rowClass}`}
                            key={product._id.$oid}
                          >
                            <td className="pageboletimtecnico__tablecontent--name">
                              {product.name}
                            </td>
                            <td>
                              <ButtonAtv
                              ...
                              />
                              <ButtonAtv
                                link={product.boletim}
                                target="_blank"
                                largura=""
                                nome="boletim tecnico"
                              />
                            </td>
                          </tr>
                        );
